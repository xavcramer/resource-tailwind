        ...
        <>
            <header className='w-[full] h-[fit]'>
                <div className='w-[full] h-[900px] bg-header-img bg-cover bg-center relative z-1'>
                    <div class='w-[74%] h-[700px] ml-[13%] mr-[13%]'>
                        <div class='w-[full] h-[790px] md:flex items-center'>
                            <div class='w-[full] h-[full] md:flex-wrap'>
                                ...
                                <div class='w-[500px] h-[full] md:flex gap-x-[20px] justify-center items-center mt-[3vh]'>
                ...
                <div class='w-[78%] h-[fit] ml-[11%] mr-[11%]'>
                    <div class='md:flex items-center justify-between'>
                        ...
                        <div class='w-[800px] h-[375px] bg-header-block bg-no-repeat bg-cover bg-center bottom-[8vh] left-[21.7vh] relative z-2 md:flex-col justify-center items-center text-white'>
                            ...
                            <div class='w-[full] h-[full] md:flex pl-[8vh]'>
                                <img src={headerhuman1} alt="" class='w-[200px] h-[200px] relative z-3 left-[-4vh]' />
                                <img src={headerhuman2} alt="" class='w-[200px] h-[200px] relative z-4 left-[-18vh] top-[3vh]' />
                                <img src={headerhuman3} alt="" class='w-[200px] h-[200px] relative z-3 left-[-30vh]' />
                                <button class='w-[146px] h-[50px] box bg-salad text-[15px] relative right-[38vh] top-[6vh] z-5'>meet our team</button>
                            </div>
                        </div>
                    </div>
                </div>
